...
namespace Drupal\webform_voting\Plugin\WebformHandler;
 ...
 * @WebformHandler(
 *   id = "voteSubmission",
 *   label = @Translation("Vote Submission"),
...
class VoteWebformHandler extends WebformHandlerBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission) {
      ...
      if ($node instanceof \Drupal\node\NodeInterface) {
          ...
          $nid = $node->id();
          $vote_before=$node->get('field_vote_value')->value;
          $node->field_vote_value=$vote_before+1;
          $vote_after=$node->get('field_vote_value')->value;
          $node->save();
